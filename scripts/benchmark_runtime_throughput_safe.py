"""Run the runtime throughput benchmark and publish traceback on failure."""
...
from benchmark_runtime_throughput import main as benchmark_main
...
def main() -> int:
    try:
        ...
        ok, message = publish_handoff(
            REPO_ROOT,
            payload,
            commit_message="handoff: runtime benchmark traceback",
            auto_push=True,
        )
