"""Run the Phase 5 PURE recommender pilot and publish fatal tracebacks."""
...
from run_phase5_pure_recommender import EXPERIMENT, main as run_main
...
def main() -> int:
    try:
        ...
        ok, message = publish_handoff(
            REPO_ROOT,
            payload,
            commit_message="handoff: phase5 PURE recommender pilot traceback",
            auto_push=True,
        )
